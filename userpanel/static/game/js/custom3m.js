    ...
    $.ajax({
      ...
      console.log(data.lastresult);
          if(data.id > 0 ){
            ...
            $("#resultball").attr("src","../../static/game/img/balls/"+ data.lastresult +".png").addClass("child15");
            $("#resultballsmall").attr("src","../../static/game/img/balls/"+ data.lastresult +".png").addClass("child15");
            ...
            var table = '<table class="table table-dark" style="color:gold"> <thead><tr><th style="color:gold"> Period </th><th style="color:gold"> Price </th><th style="color:gold"> Color </th><th style="color:gold"> Number </th></tr></thead>';
              ...
              table += ('</tr>');
                ...
                table += ('<tr>');
                table += ('<td colspan=5 style="text-align:right"><a href="result3m"><button class="btn btn-xs btn-success">More</button</a></td>');
                table += ('</tr>');
